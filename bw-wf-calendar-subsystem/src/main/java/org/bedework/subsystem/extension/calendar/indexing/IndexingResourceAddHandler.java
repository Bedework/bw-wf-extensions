...
import static org.bedework.subsystem.extension.calendar.indexing.IndexingResourceDefinition.ALL_ATTRIBUTES;
import static org.bedework.subsystem.extension.calendar.indexing.IndexingResourceDefinition.TAG_NAME;
 ...
 *
 */
public class IndexingResourceAddHandler extends AbstractAddStepHandler {
  public static IndexingResourceAddHandler INSTANCE =
          new IndexingResourceAddHandler();

  private IndexingResourceAddHandler() {}
  ...
  protected void populateModel(final ModelNode operation,
    ...
    if (!operation.get(OP).asString().equals(ADD)) {
      throw new OperationFailedException("Unexpected operation for add indexing." +
                                                 " operation=" + operation);
    }
